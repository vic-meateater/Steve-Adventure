...
namespace SteveAdventure
{
    ...
    {
        public EnemyBrain(Mover mover, Transform[] waypoints, Collider2D collider, float waitDuration)
        {
            State patrolState = new PatrolState(this, mover, waypoints, collider);
